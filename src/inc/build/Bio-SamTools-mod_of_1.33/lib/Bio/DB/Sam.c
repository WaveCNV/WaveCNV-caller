...
#line 223 "lib/Bio/DB/Sam.xs"
    RETVAL = sam_open(filename);
#line 301 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
...
XS(XS_Bio__DB__Tam_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			"Bio::DB::Tam::DESTROY",
			"tam");
#line 232 "lib/Bio/DB/Sam.xs"
     sam_close(tam);
#line 332 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
#line 240 "lib/Bio/DB/Sam.xs"
      RETVAL = sam_header_read2(filename);
#line 360 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
...
XS(XS_Bio__DB__Tam_header_read)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Tam")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"tam", "Bio::DB::Tam");
#line 249 "lib/Bio/DB/Sam.xs"
      RETVAL = sam_header_read(tam);
#line 392 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "Bio::DB::Bam::Header", (void*)RETVAL);
    }
    XSRETURN(1);
...
#line 259 "lib/Bio/DB/Sam.xs"
       RETVAL = sam_read1(tam,header,alignment);
#line 445 "lib/Bio/DB/Sam.c"
...
#line 271 "lib/Bio/DB/Sam.xs"
    RETVAL = fai_load(filename);
#line 474 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
...
XS(XS_Bio__DB__Sam__Fai_destroy)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Sam::Fai")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"fai", "Bio::DB::Sam::Fai");
#line 280 "lib/Bio/DB/Sam.xs"
    fai_destroy(fai);
#line 505 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
#line 288 "lib/Bio/DB/Sam.xs"
    char     *seq;
    int       len;
#line 527 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Sam::Fai")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"fai", "Bio::DB::Sam::Fai");
#line 291 "lib/Bio/DB/Sam.xs"
    seq = fai_fetch(fai,reg,&len);
    if (seq == NULL)
       XSRETURN_EMPTY;
    RETVAL = newSVpv(seq,len);
    free((void*)seq);
#line 544 "lib/Bio/DB/Sam.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Bio__DB__Bam_max_pileup_cnt); /* prototype to pass -Wmissing-prototypes */
XS(XS_Bio__DB__Bam_max_pileup_cnt)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
	...
	int	RETVAL;
	dXSTARG;
#line 305 "lib/Bio/DB/Sam.xs"
	if (items > 1)
	   MaxPileupCnt = SvIV(ST(1));
	RETVAL = MaxPileupCnt;
#line 569 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 318 "lib/Bio/DB/Sam.xs"
        RETVAL = bam_open(filename,mode);
#line 599 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
...
XS(XS_Bio__DB__Bam_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			"Bio::DB::Bam::DESTROY",
			"bam");
#line 327 "lib/Bio/DB/Sam.xs"
   bam_close(bam);
#line 630 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_Bio__DB__Bam_index_build)
{
	...
	int	RETVAL;
	dXSTARG;
#line 334 "lib/Bio/DB/Sam.xs"
     RETVAL = bam_index_build(filename);
#line 653 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 355 "lib/Bio/DB/Sam.xs"
    RETVAL = bam_index_load(filename);
#line 718 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
...
XS(XS_Bio__DB__Bam_header)
{
    ...
    {
	Bio__DB__Bam	bam;
#line 364 "lib/Bio/DB/Sam.xs"
      bam_header_t *bh;
      int64_t       result;
#line 741 "lib/Bio/DB/Sam.c"
	Bio__DB__Bam__Header	RETVAL;
...
XS(XS_Bio__DB__Bam_header_write)
{
	...
	if (SvROK(ST(1)) && sv_derived_from(ST(1), "Bio::DB::Bam::Header")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			"Bio::DB::Bam::header_write",
			"header", "Bio::DB::Bam::Header");
#line 379 "lib/Bio/DB/Sam.xs"
      bgzf_seek(bam,0,0);
      RETVAL= bam_header_write(bam,header);
#line 800 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam_seek)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			"Bio::DB::Bam::seek",
			"bam", "Bio::DB::Bam");
#line 403 "lib/Bio/DB/Sam.xs"
    bam_seek(bam,pos,dir);
#line 867 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_Bio__DB__Bam_read1)
{
    ...
    {
	Bio__DB__Bam	bam;
#line 410 "lib/Bio/DB/Sam.xs"
    bam1_t *b;
#line 887 "lib/Bio/DB/Sam.c"
...
#line 427 "lib/Bio/DB/Sam.xs"
      RETVAL = bam_write1(bam,align);
#line 948 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 438 "lib/Bio/DB/Sam.xs"
      RETVAL = bam_init1();
#line 976 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "Bio::DB::Bam::Alignment", (void*)RETVAL);
    }
    XSRETURN(1);
...
XS(XS_Bio__DB__Bam__Alignment_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			...
			"b");
#line 447 "lib/Bio/DB/Sam.xs"
    bam_destroy1(b);
#line 1007 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
#line 454 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->core.tid = SvIV(ST(1));
    RETVAL=b->core.tid;
#line 1040 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_pos)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 465 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->core.pos = SvIV(ST(1));
    RETVAL=b->core.pos;
#line 1074 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_calend)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 476 "lib/Bio/DB/Sam.xs"
   RETVAL=bam_calend(&b->core,bam1_cigar(b));
#line 1106 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_cigar2qlen)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 485 "lib/Bio/DB/Sam.xs"
   RETVAL=bam_cigar2qlen(&b->core,bam1_cigar(b));
#line 1138 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_qual)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 494 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->core.qual = SvIV(ST(1));
    RETVAL=b->core.qual;
#line 1172 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_n_cigar)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 516 "lib/Bio/DB/Sam.xs"
  if (items > 1)
    b->core.n_cigar = SvIV(ST(1));
    RETVAL=b->core.n_cigar;
#line 1240 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_l_qseq)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 527 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->core.l_qseq = SvIV(ST(1));
    RETVAL=b->core.l_qseq;
#line 1274 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_qseq)
{
    ...
    {
	Bio__DB__Bam__Alignment	b;
#line 538 "lib/Bio/DB/Sam.xs"
    char* seq;
    int   i;
#line 1296 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
...
XS(XS_Bio__DB__Bam__Alignment__qscore)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 555 "lib/Bio/DB/Sam.xs"
    RETVAL = newSVpv(bam1_qual(b),b->core.l_qseq);
#line 1346 "lib/Bio/DB/Sam.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Bio__DB__Bam__Alignment_mtid)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 564 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->core.mtid = SvIV(ST(1));
    RETVAL=b->core.mtid;
#line 1381 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_mpos)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 575 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->core.mpos = SvIV(ST(1));
    if (b->core.pos <= 0)
      XSRETURN_UNDEF;
    RETVAL=b->core.mpos;
#line 1417 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_l_aux)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 599 "lib/Bio/DB/Sam.xs"
    if (items > 1)
      b->l_aux = SvIV(ST(1));
    RETVAL=b->l_aux;
#line 1485 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_aux)
{
    ...
    {
	Bio__DB__Bam__Alignment	b;
#line 609 "lib/Bio/DB/Sam.xs"
   uint8_t *s;
   uint8_t type, key[2];
   char    str[8192];
#line 1508 "lib/Bio/DB/Sam.c"
	char *	RETVAL;
	dXSTARG;
...
#line 659 "lib/Bio/DB/Sam.xs"
   int           type;
   uint8_t       *s;
#line 1581 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
...
XS(XS_Bio__DB__Bam__Alignment_aux_keys)
{
    ...
    {
	Bio__DB__Bam__Alignment	b;
#line 706 "lib/Bio/DB/Sam.xs"
   uint8_t *s;
   uint8_t type;
#line 1654 "lib/Bio/DB/Sam.c"
...
XS(XS_Bio__DB__Bam__Alignment_data)
{
    ...
    {
	Bio__DB__Bam__Alignment	b;
#line 732 "lib/Bio/DB/Sam.xs"
    STRLEN  len;
#line 1703 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 734 "lib/Bio/DB/Sam.xs"
    if (items > 1) {
      b->data     = SvPV(ST(1),len);
      b->data_len = len;
    }
    RETVAL=newSVpv(b->data,b->data_len);
#line 1720 "lib/Bio/DB/Sam.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Bio__DB__Bam__Alignment_m_data)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 758 "lib/Bio/DB/Sam.xs"
    if (items > 1) {
      b->m_data = SvIV(ST(1));
    }
    RETVAL=b->m_data;
#line 1790 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_qname)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 770 "lib/Bio/DB/Sam.xs"
    RETVAL=newSVpv(bam1_qname(b),0);
#line 1821 "lib/Bio/DB/Sam.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Bio__DB__Bam__Alignment_paired)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 779 "lib/Bio/DB/Sam.xs"
    RETVAL=(b->core.flag&BAM_FPAIRED) != 0;
#line 1854 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_proper_pair)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 788 "lib/Bio/DB/Sam.xs"
    RETVAL=(b->core.flag&BAM_FPROPER_PAIR) != 0;
#line 1886 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_unmapped)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 797 "lib/Bio/DB/Sam.xs"
    RETVAL=(b->core.flag&BAM_FUNMAP) != 0;
#line 1918 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_reversed)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 815 "lib/Bio/DB/Sam.xs"
  RETVAL=bam1_strand(b);
#line 1982 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_mreversed)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"b", "Bio::DB::Bam::Alignment");
#line 824 "lib/Bio/DB/Sam.xs"
  RETVAL=bam1_mstrand(b);
#line 2014 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Alignment_cigar)
{
    ...
    {
	Bio__DB__Bam__Alignment	b;
#line 833 "lib/Bio/DB/Sam.xs"
    int        i;
    uint32_t  *c;
    AV        *avref;
#line 2037 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
...
XS(XS_Bio__DB__Bam__Header_new)
{
    ...
    {
	Bio__DB__Bam__Header	RETVAL;
#line 851 "lib/Bio/DB/Sam.xs"
    RETVAL = bam_header_init();
#line 2076 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "Bio::DB::Bam::Header", (void*)RETVAL);
    }
    XSRETURN(1);
...
#line 860 "lib/Bio/DB/Sam.xs"
    RETVAL = bamh->n_targets;
#line 2109 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Header_target_len)
{
    ...
    {
	Bio__DB__Bam__Header	bamh;
#line 884 "lib/Bio/DB/Sam.xs"
    int i;
    AV * avref;
#line 2170 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
...
XS(XS_Bio__DB__Bam__Header_text)
{
    ...
    {
	Bio__DB__Bam__Header	bamh;
#line 898 "lib/Bio/DB/Sam.xs"
    char   *newtext;
    STRLEN n;
#line 2209 "lib/Bio/DB/Sam.c"
	SV *	RETVAL;
...
#line 917 "lib/Bio/DB/Sam.xs"
       int seqid,start,end;
#line 2253 "lib/Bio/DB/Sam.c"
...
XS(XS_Bio__DB__Bam__Header_view1)
{
	...
	if (SvROK(ST(1)) && sv_derived_from(ST(1), "Bio::DB::Bam::Alignment")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			"Bio::DB::Bam::Header::view1",
			"alignment", "Bio::DB::Bam::Alignment");
#line 941 "lib/Bio/DB/Sam.xs"
       bam_view1(bamh,alignment);
#line 2319 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_Bio__DB__Bam__Header_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			...
			"bamh");
#line 948 "lib/Bio/DB/Sam.xs"
    bam_header_destroy(bamh);
#line 2348 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
XS(XS_Bio__DB__Bam__Index_fetch)
{
	...
	CV*	callback;
	SV*	callbackdata;
#line 962 "lib/Bio/DB/Sam.xs"
  fetch_callback_data fcd;
#line 2374 "lib/Bio/DB/Sam.c"
	int	RETVAL;
	dXSTARG;
...
XS(XS_Bio__DB__Bam__Index_lpileup)
{
	...
	CV*	callback;
	SV*	callbackdata;
#line 982 "lib/Bio/DB/Sam.xs"
  fetch_callback_data fcd;
  bam_lplbuf_t        *pileup;
#line 2442 "lib/Bio/DB/Sam.c"
...
XS(XS_Bio__DB__Bam__Index_pileup)
{
	...
	CV*	callback;
	SV*	callbackdata;
#line 1002 "lib/Bio/DB/Sam.xs"
  fetch_callback_data fcd;
  bam_plbuf_t        *pileup;
#line 2508 "lib/Bio/DB/Sam.c"
...
#endif
    if (items < 5 || items > 8)
       croak_xs_usage(cv,  "bai, bfp, ref, start, end, bins=0, filter=newAV(), maxcnt=8000");
    {
	Bio__DB__Bam__Index	bai;
	Bio__DB__Bam	bfp;
	int	ref = (int)SvIV(ST(2));
...
XS(XS_Bio__DB__Bam__Index_DESTROY)
{
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not a reference",
			...
			"bai");
#line 1098 "lib/Bio/DB/Sam.xs"
    bam_index_destroy(bai);
#line 2715 "lib/Bio/DB/Sam.c"
    }
    XSRETURN_EMPTY;
}
...
#line 1106 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->qpos;
#line 2746 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_pos)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1114 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->qpos+1;
#line 2778 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_indel)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1122 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->indel;
#line 2810 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_level)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1130 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->level;
#line 2842 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_is_del)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1138 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->is_del;
#line 2874 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_is_refskip)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1146 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->is_refskip;
#line 2906 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_is_head)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1154 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->is_head;
#line 2938 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_is_tail)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1162 "lib/Bio/DB/Sam.xs"
    RETVAL = pl->is_tail;
#line 2970 "lib/Bio/DB/Sam.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS(XS_Bio__DB__Bam__Pileup_b)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			"Bio::DB::Bam::Pileup::b",
			"pl", "Bio::DB::Bam::Pileup");
#line 1170 "lib/Bio/DB/Sam.xs"
    RETVAL = bam_dup1(pl->b);
#line 3001 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "Bio::DB::Bam::Alignment", (void*)RETVAL);
    }
    XSRETURN(1);
...
XS(XS_Bio__DB__Bam__Pileup_alignment)
{
	...
	if (SvROK(ST(0)) && sv_derived_from(ST(0), "Bio::DB::Bam::Pileup")) {
	    ...
	    Perl_croak(aTHX_ "%s: %s is not of type %s",
			...
			"pl", "Bio::DB::Bam::Pileup");
#line 1178 "lib/Bio/DB/Sam.xs"
    RETVAL = bam_dup1(pl->b);
#line 3033 "lib/Bio/DB/Sam.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "Bio::DB::Bam::Alignment", (void*)RETVAL);
    }
    XSRETURN(1);
...
XS(boot_Bio__DB__Sam)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXS("Bio::DB::Bam::max_pileup_cnt", XS_Bio__DB__Bam_max_pileup_cnt, file);
